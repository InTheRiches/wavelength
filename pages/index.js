                ...
                <div className={"flex flex-col h-full w-full"}>
                    <div className={"flex flex-row items-center w-full h-full z-10"}>
                        ...
                        <div className={"relative w-1/3 h-full flex flex-col justify-center"}>
                            <img className={"mt-5 sm:w-32 sm:h-32 lg:w-64 lg:h-64 2xl:w-172 2xl:h-172"} src={"/manRunningLogo.png"}  alt={"Wavelength"}></img>
                            <div className={"h-full max-w-3xl mt-8"}>
                                <div className={"p-10 py-6 sm:py-5 2xl:py-16 flex flex-col rounded-lg shadow-button dark:shadow-quote w-full mx-auto text-xl lg:text-2xl text-slate-600 dark:text-slate-50 bg-white dark:bg-neutral-900 bg-opacity-0 dark:bg-opacity-40 dark:backdrop-blur-xl slant"}>
