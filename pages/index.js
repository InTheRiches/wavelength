                        ...
                        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-3 gap-y-16 gap-x-12">
                            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                                ...
                                <ul className="flex items-center space-x-3 mt-9">
                                    {/*<li>*/}
                                    {/*    <a href="#" title="" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-cyan-accent focus:bg-cyan-accent">*/}
                                    ...
                                    <li>
                                        <a href="https://www.instagram.com/wavelength_fitness/?utm_source=ig_embed&amp;utm_campaign=loading" title="" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-9 h-9 hover:bg-cyan-accent focus:bg-cyan-accent">
