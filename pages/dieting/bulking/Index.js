...
export default function DietBulking({}) {
    const content = (
        <div className="w-full max-w-5xl flex-col">
            ...
            <InformationBlock
                title={"Note"}
                content={"Everyone's body is unique, those numbers are general outlines, but you should experiment and find what works best for your body. What works for someone might not work for you."}
                ></InformationBlock>
        </div>
    );
