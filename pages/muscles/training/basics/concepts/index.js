    ...
    const content = (
        <div className="w-full max-w-5xl flex-col">
            ...
            <Content
                ...
                content={"Research suggests ([https://pubmed.ncbi.nlm.nih.gov/15574075/,Goto et al., 2004]) that performing a single set of an exercise of high reps (15-30) to complete muscular failure after your existing normal sets can significantly improve muscle growth. Goto et al. (2004) found that performing a single set of low-intensity and high-repetition exercise added immediately after the previous regimen **without rest** showed significantly larger increases in [/muscles/training/basics/concepts#terminology,1RM] leg press and muscular endurance of leg extension compared to just the original regimen. The muscle's **cross sectional area** (CSA, essentially the size of the muscle) also increased. This means that by adding this finisher set, you can significantly increase both muscular **strength and endurance**, as well as the muscle's size."}
            ></Content>
        </div>
    )

    return (
        <ContentPage title={"Concepts"} description={<span>Weight lifting may seem complicated at first, especially with all the various terminology and concepts thrown around. Despite the initial reaction, these ideas are actually very simple. By breaking them down into their basics, you can fully grasp the concepts and utilize what they have to offer.</span>} content={content}></ContentPage>
    )
}