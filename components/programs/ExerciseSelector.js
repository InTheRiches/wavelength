    ...
    return [
        ...
        <div className={"absolute z-50 h-[80vh] overflow-y-scroll bg-white rounded-xl left-0 right-0 top-24 pt-5 mx-auto w-full max-w-[1280px]"}>
            <div className={"flex flex-col items-center justify-center px-6"}>
                <div className={"flex flex-col items-center justify-between w-full fixed max-w-[1280px] left-0 right-0 mx-auto top-24 pt-4 bg-white pb-4 px-4 rounded-xl"}>
                ...
                <table className={"mt-20 w-full table-border-spacing border-separate table-auto exerciseTable"}>
                        <thead>
