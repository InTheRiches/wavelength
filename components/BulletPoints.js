                            ...
                            {bulletPoint.title && <strong className="block dark:text-slate-50 mb-1 min-[424px]:text-xl text-lg">{
                                bulletPoint.title.match(/\[([^\]]+)\]\(([^)]+)\)/g) ?
                                    <span className="inline">
                                        ...
                                        <svg onClick={() => handleClick(/\[([^\]]+)\]\(([^)]+)\)/g.exec(bulletPoint.title)[2], router)} xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512" className="ml-2 hover:cursor-pointer inline mb-1">
