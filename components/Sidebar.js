...
function Sidebar({ currentTopic, disable=true }) {
    ...
    return (
        <div className="flex flex-col h-full w-full max-w-1/5">
            <div id="sidebar" style={{ maxHeight: remainingHeight + "px" }} className={`sidebar-taper pb-6  sticky top-20 overflow-y-auto z-10 bg-white dark:bg-neutral-900 px-4 mt-15 pr-4 text-neutral-900 dark:text-slate-50 hidden sm:flex flex-col`}>
