                                                                ...
                                                                <div
                                                                    ...
                                                                    className={`${
                                                                        currentTopic === topic.title + "-" + subtopic.title + "-" + subsubtopic.title
                                                                            ? 'text-cyan-accent border-cyan-accent'
                                                                            : 'text-neutral-700 dark:text-slate-300 border-neutral-200 dark:border-neutral-700'
                                                                    } flex items-center transition-all duration-200 hover:cursor-pointer py-1 text-xl hover:text-cyan-accent hover:dark:text-cyan-accent border-l-1 justify-between`}
                                                                    onClick={() => {
                    ...
                    {h1List.map((h1, index) => {
                        return (
                            <div key={index+150} className="text-lg mb-1 pb-2 flex flex-col w-fit items-center">
                                <a className={`w-full pb-3 ${h1List.length === index+1 ? "" : "border-b-1.5"} dark:border-neutral-300 border-neutral-600 hover:text-cyan-accent dark:hover:text-cyan-accent dark:text-slate-300 transition-colors duration-75 hover:cursor-pointer`} onClick={() => router.push(`#${h1.split(":")[1]}`).then(() => scroll())}>{h1.split(":")[0]}</a>
                            </div>
                        );
                    })}
                </div>
