...
export function WarningBlock({ title, content }) {
    ...
    return (
        <div>
            <div className="flex rounded-md border-1 border-yellow-200 bg-yellow-50 dark:bg-black dark:bg-opacity-20 p-4 min-[424px]:text-md text-lg text-yellow-500 dark:text-yellow-200 mb-6">
